 ...
 */
    ...
    class Application_Model_NanoSha256
    {
        ...
        /*
         * NOTICE!!! This function is PRIVATE. DO NOT SHARE.
         */
        function getSaltedHash($username, $password){
        	return $this->hash($password . strtolower($username) . strrev($password));
        }
